            ...
            <div class="space-y-2">
              ...
              <div class="grid grid-cols-2 gap-2">
                ...
                <button 
                  type="button"
                  @click="handleNaverLogin"
                  class="py-2.5 px-3 rounded-xl font-bold text-xs text-white transition active:scale-[0.98] flex items-center justify-center gap-2 shadow-2xs hover:brightness-95 cursor-pointer"
                  style="background-color: #03C75A;"
                >
                  <span class="font-black text-xs bg-white text-[#03C75A] w-3.5 h-3.5 rounded-xs flex items-center justify-center text-[9px]">N</span>
                  <span>네이버 가입</span>
                </button>
              </div>
            </div>
