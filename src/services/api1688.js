...
const KO_ZH_B2B_DICT = {
  ...
  // ── 몰 메인 홈 섹션(HOME_SECTION_POOLS, MallView.vue) 전용 고정 번역 ──
  // 파파고가 현재 비활성(TRANSLATION_ENABLED 킬스위치 OFF / 키 인증 실패)이라
  // 검색어 번역이 조용히 무시되고 한글 원문이 그대로 1688에 전송되어 결과 0건이 되는
  // 문제를 근본적으로 차단하기 위해, 6개 홈 섹션이 실제로 사용하는 검색어 전체를
  // 사전에 직접 등록함 (1순위 사전 조회이므로 파파고 가용 여부와 무관하게 항상 동작)
  '베스트 인기상품': '爆款人气商品', '신상품 인기템': '新款人气单品', '온라인 셀러 인기 아이템': '网红爆款单品',
  '블라우스 셔츠': '女士衬衫', '니트 가디건': '针织开衫', '슬랙스 바지': '休闲西裤',
  '자켓 코트': '外套大衣', '맨투맨 후드': '卫衣',
  '텀블러 물병': '保温杯水壶', '식기 접시': '餐具盘子', '밀폐용기': '保鲜盒',
  '욕실용품 청소도구': '浴室清洁用品', '수납 정리함': '收纳整理箱', '우산 양산': '雨伞太阳伞',
  '캠핑의자 캠핑테이블': '户外露营椅露营桌', '캠핑랜턴 캠핑매트': '露营灯露营垫', '텐트 타프': '帐篷天幕',
  '헬스 요가용품': '健身瑜伽用品', '골프용품': '高尔夫用品', '자전거용품': '自行车用品',
  '블루투스 이어폰': '蓝牙耳机', '핸드폰 케이스': '手机壳', '충전기 케이블': '充电器数据线',
  '보조배터리': '充电宝', '차량용 거치대': '车载支架', '블랙박스 액세서리': '行车记录仪配件',
  '스킨 로션': '爽肤水乳液', '마스크팩': '面膜', '선크림': '防晒霜',
  '립스틱 메이크업': '口红化妆品', '고데기 헤어드라이어': '卷发棒吹风机', '네일용품': '美甲用品',
}
