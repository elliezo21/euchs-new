<template>
  <div class="space-y-6">
    ...
    <div class="md:hidden space-y-3">
      <!-- Empty State (모바일) -->
      <div v-if="filteredOrders.length === 0" class="bg-white border border-gray-200 rounded-2xl py-16 text-center text-gray-400 text-xs">
        <Package class="w-10 h-10 mx-auto text-gray-300 mb-2" />
        <p class="font-medium">선택한 조건의 발주/주문 내역이 없습니다.</p>
        <router-link
          to="/mall"
    ...
    <!-- ======================================================== -->
    <!-- 6. 주문 상세 모달 (OrderDetailModal 컴포넌트) -->
    <!-- ======================================================== -->
    <OrderDetailModal
